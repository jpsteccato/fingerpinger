...
# =========================
# build_package.sh
# Build, Code Sign, and Package fingerpinger
# =========================
...
mkdir -p "$EXTERNALS_DIR" "$MEDIA_DIR"
...
cd "$PACKAGE_DIR/.."
mv package fingerpinger
zip -r "$ZIP_NAME" fingerpinger/
mv fingerpinger package
