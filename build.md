...
Instructions for maintainers preparing a new versioned release of the package.
...
1. Go to: [GitHub Releases](https://github.com/jpsteccato/fingerpinger/releases)
2. Click **“Draft a new release”**
3. Fill out:

   * **Tag name**: `v1.0.0`
   * **Release title**: `fingerpinger v1.0.0`
4. Upload the `fingerpinger.zip` file
5. Click **Publish**
...
* Final `fingerpinger.zip` must include:
